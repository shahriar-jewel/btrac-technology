...
app.setMenu("main", {
    items: [
        ...
        { name: "Report", path: "/report/weight-data", for: [Role.Admin, Role.Manager, Role.User] },
        { name: "<i class='large material-icons'>people</i>", path: "/users", for: [Role.Admin, Role.Manager, Role.User] },
        { name: "<i class='large material-icons'>security</i>", path: "/password/change", for: [Role.Admin, Role.Manager, Role.User] },
        { name: "<i class='large material-icons'>exit_to_app</i>", path: "/logout", for: [Role.Admin, Role.Manager, Role.User] }
    ]
})
